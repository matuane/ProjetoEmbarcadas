...
# 2 "centralDesarmada.c" 2

# 1 "./bits.h" 1
# 3 "centralDesarmada.c" 2
...
# 5 "centralDesarmada.c" 2

# 1 "./delay.h" 1
# 11 "./delay.h"
void delay(int valor);
# 6 "centralDesarmada.c" 2
